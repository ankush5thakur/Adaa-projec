      ...
      <div className="sm:bg-gradient-to-br sm:from-slate-50 sm:to-slate-200 bg-slate-100">
        <header>
          <nav className="bg-gradient-to-b from-navbar-from via-navbar-via to-navbar-to flex flex-wrap px-4 py-2 md:py-0 border border-navbar-border items-center justify-between w-full">
            <div className="justify-self-start logo navbar-font">
              <a href="/">Ankush & Abhishek</a>
            </div>
            ...
            >
              <ul className="md:flex md:justify-between">
                ...
                <li>
                  <a className="navbar-link" href="/feed.xml">
                    RSS
                  </a>
                </li>
                <li>
                  <a
                    className="navbar-tipjar"
                    href={tipJarLink}
                    target="_blank"
                    rel="noreferrer"
                  >
                    <img src={kofi} alt="The kofi logo of a coffee mug" />
                  </a>
                </li>
              </ul>
            </div> */}
        ...
        <div className="rounded">
          <div className="flex justify-center gap-x-2">
            ...
            <div className="self-center text-4xl md:text-6xl text-[#BF392C]">
